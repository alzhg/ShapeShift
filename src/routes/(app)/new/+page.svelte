<script lang="ts">
    ...
    let tags: string[] = [];
    let tagInput = "";
    let photoUrl = ""; // New variable to store the photo URL
</script>

<svelte:head>
    <title>New Post - SS</title>
</svelte:head>
...
<article>
    <form
        ...
        use:enhance={({ formData }) => {
            ...
            formData.append("photo", photoUrl); // Append the photo URL to the form data
        }}
    >
        ...
        <div class="input-container">
            ...
            <select name="language" bind:value={language}>
                ...
                <option value="c">Spanish</option>
                <option value="cpp">French</option>
                <option value="dart">German</option>
                <option value="go">Mandarin</option>
                <option value="java">Thai</option>
                <option value="js">Japanese</option>
                <option value="ts">Arabic</option>
                <option value="py">Portuguese</option>
                <option value="rs">Italian</option>
            </select>
        </div>
        ...
        <div class="input-container">
            ...
            <input
                type="url"
                placeholder="Enter image URL for the post"
                bind:value={photoUrl}
            />
        </div>
        ...
        <Button
            variant="primary"
            disabled={title === "" || content === "" || language === "" || tags.length === 0}
        >
            Post
        </Button>
    </form>
