...
<div class="flex justify-between items-center min-h-screen">
  ...
  <div class="flex flex-col mr-44 bg-white p-6 rounded-lg shadow-md w-96 h-auto">
    ...
    <div class="flex flex-col shadow-sm border border-black rounded-md">
      <input type="email" id="email" bind:value={email} placeholder="Username" required class="bg-shapeshift-light-green rounded-md h-10 px-2"/>
    </div>
    
    <!-- Password Field -->
    <div class="flex flex-col shadow-sm mt-4 border border-black rounded-md">
      <input type="password" id="password" bind:value={password} placeholder="Password" required class="bg-shapeshift-light-green rounded-md h-10 px-2"/>
    </div>

    <!-- Login Button -->
    <button class="bg-shape-shift-green p-2 border border-black rounded-md mt-4 hover:bg-shapeshift-dark-pastel-green">Login</button>
    ...
    <button class="bg-shapeshift-light-blue rounded-md mt-4 p-2 border border-black ">Create Account</button>
  </div>
</div>
